...
ggplot(combined_data, aes(x = Immigration_Inflow, y = GDP_Growth, color = Country)) +
  ...
  theme_minimal()
```
This graph was less helpful in supporting my hypothesis. It did not show a strong correlation between inflow and annual gdp growth. I was expecting this as GDP growth is due to many factors much of which have little to do with Immigration. 
